...
function change_all(){
    ...
    if(document.getElementsByTagName('div')[3].innerText==='Zyryanova'){
        ...
        document.getElementsByTagName('div')[6].innerHTML='жен.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;01.06.2005';
        ...
        if (document.getElementsByTagName('div')[3].innerText==='Зырянова'){
            ...
            document.getElementsByTagName('div')[6].innerText='01.06.2005. \nfem.';
            ...
            document.getElementsByTagName('div')[6].style.marginTop='34px';
